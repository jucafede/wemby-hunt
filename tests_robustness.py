...
conn = hunt.db()
conn.execute("INSERT INTO products_raw (shop,handle,title,variant_title,vendor,product_type,price,compare_at,available,url,season,fmt,sport,config,sku_id,match_score,candidates,seen_at) VALUES ('sh','h','t','',NULL,NULL,1,NULL,1,'u',NULL,NULL,NULL,NULL,NULL,0,'[]','2026-01-01T00:00:00')")
conn.execute("INSERT INTO products_raw (shop,handle,title,variant_title,vendor,product_type,price,compare_at,available,url,season,fmt,sport,config,sku_id,match_score,candidates,seen_at) VALUES ('sh','h2','t','',NULL,NULL,1,NULL,1,'u',NULL,NULL,NULL,NULL,NULL,0,'[]','2026-01-02T00:00:00')")
...
conn2 = hunt.db()
conn2.execute("INSERT OR REPLACE INTO products_raw (shop,handle,title,variant_title,vendor,product_type,price,compare_at,available,url,season,fmt,sport,config,sku_id,match_score,candidates,seen_at) VALUES ('t1','h','x','',NULL,NULL,1,NULL,1,'u',NULL,NULL,NULL,NULL,NULL,0,'[]','2026-03-01T00:00:00')")
conn2.execute("INSERT OR REPLACE INTO products_raw (shop,handle,title,variant_title,vendor,product_type,price,compare_at,available,url,season,fmt,sport,config,sku_id,match_score,candidates,seen_at) VALUES ('t1','h2','x','',NULL,NULL,1,NULL,1,'u',NULL,NULL,NULL,NULL,NULL,0,'[]','2026-03-02T00:00:00')")
