...
set -uo pipefail
fail=0
for t in tests_matching tests_robustness tests_badges tests_ui tests_history tests_health tests_thresholds tests_cockpit tests_fr tests_market tests_inventory tests_html tests_alerts tests_sold tests_autonomy tests_guardrails tests_europe; do
